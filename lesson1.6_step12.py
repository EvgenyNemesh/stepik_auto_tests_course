...
try:
    ...
    input3.send_keys("Evgeny.Nemesh@x5.ru")
    input4 = browser.find_element_by_xpath("//input[@placeholder='Input your phone:']")
    input4.send_keys("89772678044")
    input5 = browser.find_element_by_xpath("//input[@placeholder='Input your address:']")
    input5.send_keys("Bakinskaya")
    button = browser.find_element_by_class_name("form-control.second")
    button.click()
